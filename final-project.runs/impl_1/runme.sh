...
HD_PWD='C:/Users/Lambda/Desktop/EECS 443/Final Project/eecs443-final-project/final-project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IntersectionController.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IntersectionController.tcl -notrace
