...
HD_PWD='C:/Users/Lambda/Desktop/EECS 443/Final Project/eecs443-final-project/final-project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IntersectionController.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IntersectionController.tcl
